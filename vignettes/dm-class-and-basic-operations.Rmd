...
Here we make use of the fact, that the function `dm(src, table_names = NULL)` includes all available tables on a source in the `dm` object, should the `table_names`-argument be left `NULL`. 
