...
```{r}
cdm_get_all_pks(cdm_nycflights13())
```

We used here the prepared `dm` object `cdm_nycflights13()` as an example. 
This object comes already with set keys and is part of {dm}.
