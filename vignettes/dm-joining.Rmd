...
2. Printed in the console by calling `dm_get_all_fks()`
...
The `dm_flatten_to_tbl` cares about by automatically renaming the relevant columns and prints if something was changed, e.g. `name -> airlines.name`.
