...
The change was, that before the update, the mentioned methods would return you the table after "filtering" it to just contain the rows with values that relate via foreign key relations to other tables that were filtered earlier.
...
But we would like to make sure you are aware of the change in their implementation.
