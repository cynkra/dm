...
1. the table sources,
2. the data model,
3. and a short glimpse into the data via the number of rows.
...
These relations are best displayed as a visualization of the entity relation model:
...
This is the use-case for filtering based on an already reduced table with `cdm_semi_join()`.
