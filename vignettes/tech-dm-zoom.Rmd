...
Up to {dm} version 2.4 we tried to track the columns in a very detailed manner, but because of updates in {dplyr}, namely the function `across()`, it turned out to be the better solution to give more responsibility to the {dm} user:
