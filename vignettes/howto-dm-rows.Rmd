...
new_id <- max(dm_sqlite$accounts %>% pull(id)) + 1
...
new_account <- dm_empty$accounts %>% add_row(id = 11383, district_id = 18, frequency = "dummy", date = 9736 )
dm_data <- dm_empty %>% dm_rm_tbl(accounts) %>% dm_add_tbl(accounts = new_account)
