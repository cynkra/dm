...
#FIXME examples of dm behaving like a list. maybe around dmt <- dm(iris, mtcars), because printing this out is nice and compact?
...
[Primary keys](https://krlmlr.github.io/dm/articles/howto-dm-theory.html#pk) and [foreign keys](https://krlmlr.github.io/dm/articles/howto-dm-theory.html#fk) are how relational database tables are linked with each other.
