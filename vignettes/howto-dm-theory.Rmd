...
Therefore, {dm} can copy data [from and to databases](https://dm.cynkra.com/articles/dm.html), and works transparently with both in-memory data and with relational database systems.
