...
{dm} was designed to make connecting to and working with an RDBMS as straightforward as possible.
...
[^compound]: Support for compound keys (consisting of multiple columns) is [planned](https://github.com/cynkra/dm/issues/3).
