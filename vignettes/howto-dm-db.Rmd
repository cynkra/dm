...
There is another {dbplyr} verb that has not yet been implemented.
...
- FIXME: Integrate shorter version of `copy_dm_to()` text, reconcile
...
FIXME: reference to howto-dm-rows
