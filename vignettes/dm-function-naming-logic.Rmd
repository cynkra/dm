...
vignette: >
  %\VignetteIndexEntry{Function naming logic}
...
A `zoomed_dm` behaves in most situations like a table and there are mostly no explicit functions available for this class, but rather methods (see vignette ["Zooming and manipulating tables"](https://krlmlr.github.io/dm/articles/dm-zoom-to-table.html).
