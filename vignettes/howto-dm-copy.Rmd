...
It uses the {dm} convenience function `dm_financial()` (introduced in the previous tutorial, `vignette("howto-dm-db")`) to create a dm object corresponding to a data model from a public dataset repository. 
