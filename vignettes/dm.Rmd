...
The `dm_nycflights13()` function provides a shortcut: the `dm` object returned by this function contains all tables (by default a reduced version of table `flight`), defines all primary and foreign keys, and even assigns colors to the different types of tables.
