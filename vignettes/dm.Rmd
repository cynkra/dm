...
- Learn other ways of creating `dm` objects and basic operations on them, like handling key constraints in vignette "class 'dm' and basic operations"
- All about the possibilities of graphic representations of `dm` objects: vignette "Visualizing 'dm' objects (missing as of yet)"
- More on filtering `dm` objects, its limitations and its benefits: vignette "Filtering"
- On {dm}'s intuitive interaction with DBs: vignette "{dm} and databases"
- {dm} and {dynafilter}, a match made in {shiny}-heaven: vignette "shiny with {dynafilter}"
- Further useful tools: vignette "Miscellaneous"
