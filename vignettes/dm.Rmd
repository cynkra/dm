...
The most straightforward way of squeezing those tables into a dm object is the `dm()` function:
...
The function `dm_get_tables()` returns a named list containing the individual tables.
The dm object also behaves like a named list of tables:
