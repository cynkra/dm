...
The relevant method is `copy_to()` with the second argument being a `dm`, which will copy both data and key constraints.

```{r}
src_sqlite <- src_sqlite(":memory:", create = TRUE)
src_sqlite
flights_dm_with_keys_remote <- copy_to(src_sqlite, flights_dm_with_keys)
```
