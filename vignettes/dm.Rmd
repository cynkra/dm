...
fin_dm_small <-
  dm_from_con(fin_db, learn_keys=F) %>%
  dm_select_tbl(loans, accounts, districts, trans)
``````
...
With the argument `recursive=T`, `dm_flatten_to_tbl()` will automatically follow foreign keys across tables to gather all the available columns into a single table.
