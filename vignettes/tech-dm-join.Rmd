...
The `dm_flatten_to_tbl` takes cares of this by automatically renaming the relevant columns and informs the user if any names were changed, e.g. `name -> airlines.name`.
