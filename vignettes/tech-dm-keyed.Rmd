...
flights_tbl <- flights_dm_tbl$flights
...
weather_tbl <- flights_dm_tbl$weather
weather_tbl
...
In addition to the usual arguments for the {dplyr}-joins, by supplying the `select` argument you can specify which columns of the right-hand-side table you want to be included in the join.
...
joined_flights_tbl <-
  ...
  left_join(flights_dm_tbl$planes, select = c(tailnum, plane_type = type)) 
...
joined_flights_dm_tbl$flights_plane_type
