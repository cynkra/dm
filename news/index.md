...
- New [`dm_flatten()`](https://dm.cynkra.com/reference/dm_flatten.md)
...
- [`dm_draw()`](https://dm.cynkra.com/reference/dm_draw.md) gains a
...
- [`check_key()`](https://dm.cynkra.com/reference/check_key.md) now
...
- [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) now
  uses [`dm_sql()`](https://dm.cynkra.com/reference/dm_sql.md)
...
- [`dm_from_con()`](https://dm.cynkra.com/reference/dm_from_con.md) no
  longer learns tables from all schemas by default for Postgres, MSSQL,
  and MariaDB ([@mgirlich](https://github.com/mgirlich),
...
- [`dm_rm_fk()`](https://dm.cynkra.com/reference/dm_rm_fk.md) no longer
  issues a spurious message when foreign keys reference non-primary-key
  columns ([\#1270](https://github.com/cynkra/dm/issues/1270),
  [\#2367](https://github.com/cynkra/dm/issues/2367)).

- [`dm_paste()`](https://dm.cynkra.com/reference/dm_paste.md) limits its
  pipelines to up to 100 steps, splitting longer pipelines as needed
...
- [`dm_sql()`](https://dm.cynkra.com/reference/dm_sql.md) now processes
  `table_names` with
...
- Speed up [`dm()`](https://dm.cynkra.com/reference/dm.md),
  [`new_dm()`](https://dm.cynkra.com/reference/dm.md),
  [`as_dm()`](https://dm.cynkra.com/reference/dm.md) and
  [`dm_validate()`](https://dm.cynkra.com/reference/dm_validate.md).
  [`dm()`](https://dm.cynkra.com/reference/dm.md) and
  [`as_dm()`](https://dm.cynkra.com/reference/dm.md) no longer call
  [`dm_validate()`](https://dm.cynkra.com/reference/dm_validate.md)
...
- [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) now
  warns unconditionally on unsupported arguments, and fails if `copy_to`
  is provided ([\#1944](https://github.com/cynkra/dm/issues/1944)). Use
  the new [`dm_sql()`](https://dm.cynkra.com/reference/dm_sql.md)
  function as a replacement for `copy_dm_to(copy_to = )`
...
- New [`json_unnest()`](https://dm.cynkra.com/reference/json_unnest.md)
  and [`json_unpack()`](https://dm.cynkra.com/reference/json_unpack.md),
...
- [`dm_rows_append()`](https://dm.cynkra.com/reference/rows-dm.md) also
  works for local dm, with support for autoincrement primary keys
...
- Minor fixes in
  [`dm_pack_tbl()`](https://dm.cynkra.com/reference/dm_pack_tbl.md) and
...
- [`dm_from_con()`](https://dm.cynkra.com/reference/dm_from_con.md) can
  retrieve multiple schemas, pass a character vector to the `schema`
...
- In [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md),
...
- Progress bars for
  [`dm_wrap_tbl()`](https://dm.cynkra.com/reference/dm_wrap_tbl.md) and
  [`dm_unwrap_tbl()`](https://dm.cynkra.com/reference/dm_unwrap_tbl.md)
...
- [`dm_add_pk()`](https://dm.cynkra.com/reference/dm_add_pk.md) gains
  `autoincrement` argument
...
- New [`dm_add_uk()`](https://dm.cynkra.com/reference/dm_add_uk.md),
  [`dm_rm_uk()`](https://dm.cynkra.com/reference/dm_rm_uk.md) and
...
- Improve error message for
  [`dm_add_pk()`](https://dm.cynkra.com/reference/dm_add_pk.md) when the
  `columns` argument is missing
...
- [`dm()`](https://dm.cynkra.com/reference/dm.md) accepts tables that
  are of class `"tbl_sql"` but not `"tbl_dbi"`
...
- [`dm_from_con()`](https://dm.cynkra.com/reference/dm_from_con.md) can
  use multiple schemata ([@mgirlich](https://github.com/mgirlich),
...
- [`dm_paste()`](https://dm.cynkra.com/reference/dm_paste.md) gives
...
- Reenable
  [`dm_rows_update()`](https://dm.cynkra.com/reference/rows-dm.md) test
  ([\#1437](https://github.com/cynkra/dm/issues/1437)).
...
- Use [`dm_ptype()`](https://dm.cynkra.com/reference/dm_ptype.md) in
  [`dm_gui()`](https://dm.cynkra.com/reference/dm_gui.md), generate
...
- New [`dm_gui()`](https://dm.cynkra.com/reference/dm_gui.md) for
...
- [`dm_get_tables()`](https://dm.cynkra.com/reference/dm_get_tables.md)
  and [`pull_tbl()`](https://dm.cynkra.com/reference/pull_tbl.md) gain a
  new `keyed = FALSE` argument. If set to `TRUE`, table objects of class
  `"dm_keyed_tbl"` are returned. These objects inherit from the
  ...
  [`dm()`](https://dm.cynkra.com/reference/dm.md) to recreate a dm
...
- New `by_position` argument to
  ...
  [`check_cardinality_...()`](https://dm.cynkra.com/reference/examine_cardinality.md)
  and
  [`examine_cardinality()`](https://dm.cynkra.com/reference/examine_cardinality.md)
  ([\#1253](https://github.com/cynkra/dm/issues/1253)).

- [`dm()`](https://dm.cynkra.com/reference/dm.md) accepts dm objects
...
- [`dm_filter()`](https://dm.cynkra.com/reference/dm_filter.md) is now
  stable, with a new API that avoids exposing an intermediate state with
  filters not yet applied, with a compatibility wrapper
...
- [`dm_apply_filters()`](https://dm.cynkra.com/reference/deprecated.md),
  [`dm_apply_filters_to_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
  and
  [`dm_get_filters()`](https://dm.cynkra.com/reference/deprecated.md)
...
- [`dm_rm_tbl()`](https://dm.cynkra.com/reference/deprecated.md) is
  deprecated in favor of
  [`dm_select_tbl()`](https://dm.cynkra.com/reference/dm_select_tbl.md)
  ([\#1275](https://github.com/cynkra/dm/issues/1275)).

- [`dm_bind()`](https://dm.cynkra.com/reference/deprecated.md) and
  [`dm_add_tbl()`](https://dm.cynkra.com/reference/deprecated.md) are
  deprecated in favor of [`dm()`](https://dm.cynkra.com/reference/dm.md)
  ([\#1226](https://github.com/cynkra/dm/issues/1226)).

- [`rows_truncate()`](https://dm.cynkra.com/reference/deprecated.md) and
  [`dm_rows_truncate()`](https://dm.cynkra.com/reference/deprecated.md)
...
- [`check_key()`](https://dm.cynkra.com/reference/check_key.md) uses
...
- [`dm_draw()`](https://dm.cynkra.com/reference/dm_draw.md) works if a
  table name has a space
  ([\#1219](https://github.com/cynkra/dm/issues/1219)).

- Don’t print rule in
  [`glimpse.dm()`](https://dm.cynkra.com/reference/glimpse.dm.md) for
  empty [`dm()`](https://dm.cynkra.com/reference/dm.md)
...
- New
  ...
  [`json_pack()`](https://dm.cynkra.com/reference/json_pack.md) and
  [`json_nest()`](https://dm.cynkra.com/reference/json_nest.md), similar
  to [`pack_join()`](https://dm.cynkra.com/reference/pack_join.md),
...
- [`nest_join()`](https://dplyr.tidyverse.org/reference/nest_join.html)
  and [`pack_join()`](https://dm.cynkra.com/reference/pack_join.md)
...
- Marked stable functions as stable, in particular
  [`dm()`](https://dm.cynkra.com/reference/dm.md) and related functions
  ([\#1032](https://github.com/cynkra/dm/issues/1032),
...
- Deprecate
  [`dm_join_to_tbl()`](https://dm.cynkra.com/reference/deprecated.md),
  [`dm_is_referenced()`](https://dm.cynkra.com/reference/deprecated.md)
  and
  [`dm_get_referencing_tables()`](https://dm.cynkra.com/reference/deprecated.md)
  ([\#1038](https://github.com/cynkra/dm/issues/1038)).

- New [`dm_validate()`](https://dm.cynkra.com/reference/dm_validate.md)
  replaces now deprecated
  [`validate_dm()`](https://dm.cynkra.com/reference/deprecated.md)
  ([\#1033](https://github.com/cynkra/dm/issues/1033)).

- [`dm_get_con()`](https://dm.cynkra.com/reference/dm_get_con.md) and
  [`dm_get_filters()`](https://dm.cynkra.com/reference/deprecated.md)
...
- New [`dm_from_con()`](https://dm.cynkra.com/reference/dm_from_con.md),
  soft-deprecated
  [`dm_from_src()`](https://dm.cynkra.com/reference/dm_from_src.md)
...
- Moved [`pack_join()`](https://dm.cynkra.com/reference/pack_join.md)
...
- Better message for
  [`dm_rows_...()`](https://dm.cynkra.com/reference/rows-dm.md)
...
- [`pack_join()`](https://dm.cynkra.com/reference/pack_join.md) works
  correctly if `name` is the same as an existing column in either table.
  In some cases a column is overwritten, this is consistent with
  [`nest_join()`](https://dplyr.tidyverse.org/reference/nest_join.html)
...
- [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) shows
  progress bars again ([\#850](https://github.com/cynkra/dm/issues/850),
  [\#855](https://github.com/cynkra/dm/issues/855)).
...
- New [`dm_wrap_tbl()`](https://dm.cynkra.com/reference/dm_wrap_tbl.md),
  [`dm_unwrap_tbl()`](https://dm.cynkra.com/reference/dm_unwrap_tbl.md),
...
- New [`pack_join()`](https://dm.cynkra.com/reference/pack_join.md)
...
- `db_schema_list.Microsoft SQL Server` no longer ignoring schemas for
  ...
  ([\#815](https://github.com/cynkra/dm/issues/815),
  [\#771](https://github.com/cynkra/dm/issues/771)).
- [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) works
  with DuckDB again, the SQL statements to define the tables and indexes
  are now created by us
...
- [`dm_paste()`](https://dm.cynkra.com/reference/dm_paste.md) adds the
  `on_delete` argument to
...
- [`dm_draw()`](https://dm.cynkra.com/reference/dm_draw.md) works with
  empty tables ([\#585](https://github.com/cynkra/dm/issues/585)).
...
- [`dm_add_fk()`](https://dm.cynkra.com/reference/dm_add_fk.md) gains
  `on_delete` argument which
  [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) picks
  up and translates to an `ON DELETE CASCADE` or `ON DELETE NO ACTION`
  specification for the foreign key
...
- [`dm_paste()`](https://dm.cynkra.com/reference/dm_paste.md) output
  uses trailing commas in the
  [`dm::dm()`](https://dm.cynkra.com/reference/dm.md) and
...
- [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) and
  `sql_create_schema()` no longer actively check for schema existence
  ([\#644](https://github.com/cynkra/dm/issues/644),
...
- Better error message for
  [`dm_rows_update()`](https://dm.cynkra.com/reference/rows-dm.md) and
  related functions for dm objects with tables without primary key
...
- Fix [`dm_zoom_to()`](https://dm.cynkra.com/reference/dm_zoom_to.md)
...
- [`sql_schema_list()`](https://dm.cynkra.com/reference/deprecated.md)
  supports
  [`pool::Pool`](http://rstudio.github.io/pool/reference/Pool-class.md)
...
- Fix [`rows_truncate()`](https://dm.cynkra.com/reference/deprecated.md)
  in interactive mode
...
- [`dm_examine_constraints()`](https://dm.cynkra.com/reference/dm_examine_constraints.md),
  [`dm_rows_insert()`](https://dm.cynkra.com/reference/rows-dm.md) and
  related,
  [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) and
  [`collect.dm()`](https://dm.cynkra.com/reference/materialize.md) show
  progress bars in interactive mode via the progress package. The new
  `progress = NA` argument controls the behavior
  ([\#262](https://github.com/cynkra/dm/issues/262),
  [@moodymudskipper](https://github.com/moodymudskipper)).
- [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) gains
  a `copy_to` argument to support other ways of copying data to the
  database ([\#582](https://github.com/cynkra/dm/issues/582)).
...
- [`dm_get_pk()`](https://dm.cynkra.com/reference/dm_get_pk.md) is
  deprecated in favor of
  [`dm_get_all_pks()`](https://dm.cynkra.com/reference/dm_get_all_pks.md)
  ([\#561](https://github.com/cynkra/dm/issues/561)).
- [`dm_has_fk()`](https://dm.cynkra.com/reference/dm_has_fk.md) and
  [`dm_get_fk()`](https://dm.cynkra.com/reference/dm_has_fk.md) are
  deprecated in favor of
  [`dm_get_all_fks()`](https://dm.cynkra.com/reference/dm_get_all_fks.md)
  ([\#561](https://github.com/cynkra/dm/issues/561)).
...
- [`dm_add_fk()`](https://dm.cynkra.com/reference/dm_add_fk.md) gains
  `ref_columns` argument that supports creating foreign keys to
...
- [`dm_get_all_fks()`](https://dm.cynkra.com/reference/dm_get_all_fks.md)
  ...
  ([\#560](https://github.com/cynkra/dm/issues/560)).
- [`dm_rm_fk()`](https://dm.cynkra.com/reference/dm_rm_fk.md) gains an
  optional `ref_columns` argument. This function now supports removal of
  multiple foreign keys filtered by parent or child table or columns,
  with a message ([\#559](https://github.com/cynkra/dm/issues/559)).
- [`dm_rm_pk()`](https://dm.cynkra.com/reference/dm_rm_pk.md) gains
...
- Deprecate
  [`dm_get_src()`](https://dm.cynkra.com/reference/dplyr_src.md)
  [`tbl.dm()`](https://dm.cynkra.com/reference/dplyr_src.md),
  [`src_tbls.dm()`](https://dm.cynkra.com/reference/dplyr_src.md),
  [`copy_to.dm()`](https://dm.cynkra.com/reference/dplyr_src.md). These
  functions have better alternatives and use the notion of a “data
...
- [`dm_add_pk()`](https://dm.cynkra.com/reference/dm_add_pk.md) and
  [`dm_add_fk()`](https://dm.cynkra.com/reference/dm_add_fk.md) support
  compound keys via the [`c()`](https://rdrr.io/r/base/c.html) notation,
...
- [`rows_truncate()`](https://dm.cynkra.com/reference/deprecated.md)
...
- [`dm_draw()`](https://dm.cynkra.com/reference/dm_draw.md) gains
  ...
  [@samssann](https://github.com/samssann)).
- [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) gains
  `schema` argument ([\#432](https://github.com/cynkra/dm/issues/432)).
- [`dm_from_src()`](https://dm.cynkra.com/reference/dm_from_src.md)
...
- Fix [`dm_from_src()`](https://dm.cynkra.com/reference/dm_from_src.md)
...
- New
  [`vignette("howto-dm-copy", package = "dm")`](https://dm.cynkra.com/articles/howto-dm-copy.md)
  and
  [`vignette("howto-dm-rows", package = "dm")`](https://dm.cynkra.com/articles/howto-dm-rows.md)
  discuss updating data on the database. In part derived from
  [`vignette("howto-dm-db", package = "dm")`](https://dm.cynkra.com/articles/howto-dm-db.md)
...
- [`dm_get_src()`](https://dm.cynkra.com/reference/dplyr_src.md) returns
  `NULL` for local data sources
  ([\#394](https://github.com/cynkra/dm/issues/394)).
- Local target in
  [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) gives
...
- [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) gives
  a better error message for bad `table_names`
...
- New [`dm_bind()`](https://dm.cynkra.com/reference/deprecated.md) for
  binding two or more ‘dm’ objects together
...
- [`dm_financial()`](https://dm.cynkra.com/reference/dm_financial.md) no
  longer prints message about `learn_keys = FALSE`.
- [`dm_rows_update()`](https://dm.cynkra.com/reference/rows-dm.md) and
  related functions now use the primary keys defined in `x` for
...
- [`dm_paste()`](https://dm.cynkra.com/reference/dm_paste.md) generates
  self-contained code
...
- Implement
  [`rows_truncate()`](https://dm.cynkra.com/reference/deprecated.md) for
  databases.
...
- New [`dm_rows_insert()`](https://dm.cynkra.com/reference/rows-dm.md),
  ...
  [`dm_rows_delete()`](https://dm.cynkra.com/reference/rows-dm.md) and
  [`dm_rows_truncate()`](https://dm.cynkra.com/reference/deprecated.md),
  calling the corresponding `rows_*()` method for every table
  ([\#319](https://github.com/cynkra/dm/issues/319)).

- New [`rows_truncate()`](https://dm.cynkra.com/reference/deprecated.md)
  ([\#319](https://github.com/cynkra/dm/issues/319)).
...
- [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) also
  accepts a function as the `table_names` argument. The
...
- [`dm_from_src()`](https://dm.cynkra.com/reference/dm_from_src.md) now
  works for databases other than Postgres and MSSQL
...
- [`dm_paste()`](https://dm.cynkra.com/reference/dm_paste.md) supports
  writing colors and the table definition via the new `options`
...
- [`dm_add_tbl()`](https://dm.cynkra.com/reference/deprecated.md) uses
  [`rlang::list2()`](https://rlang.r-lib.org/reference/list2.html)
  internally, now accepts `:=` to specify table names.
- New [`dm_ptype()`](https://dm.cynkra.com/reference/dm_ptype.md)
...
- Printing dm objects from database sources with many tables is now
  ...
  [@gadenbuie](https://github.com/gadenbuie)).
- [`check_key()`](https://dm.cynkra.com/reference/check_key.md) now also
  works on a zoomed dm.
...
- [`dm_add_pk()`](https://dm.cynkra.com/reference/dm_add_pk.md),
  ...
  [`dm_add_fk()`](https://dm.cynkra.com/reference/dm_add_fk.md) and
  [`dm_rm_fk()`](https://dm.cynkra.com/reference/dm_rm_fk.md) are now
  stricter when keys exists or when attempting to remove keys that don’t
  exist. A more relaxed mode of operation may be added later
...
- [`dm_draw()`](https://dm.cynkra.com/reference/dm_draw.md) output is
  shown in examples ([\#251](https://github.com/cynkra/dm/issues/251)).
...
- Add experimental schema support for
  [`dm_from_src()`](https://dm.cynkra.com/reference/dm_from_src.md) for
  Postgres through the new `schema` and `table_type` arguments
...
- New [`pull_tbl()`](https://dm.cynkra.com/reference/pull_tbl.md)
...
- New [`dm_paste()`](https://dm.cynkra.com/reference/dm_paste.md)
  ([\#160](https://github.com/cynkra/dm/issues/160)).
- New
  [`check_cardinality()`](https://dm.cynkra.com/reference/deprecated.md)
...
- [`check_key()`](https://dm.cynkra.com/reference/check_key.md) no
  longer maps empty selection list to all columns.
- [`check_key()`](https://dm.cynkra.com/reference/check_key.md) supports
  tidyselect ([\#188](https://github.com/cynkra/dm/issues/188)).
- [`dm_rm_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
  supports tidyselect
...
- More efficient
  [`check_key()`](https://dm.cynkra.com/reference/check_key.md) for
...
- [`cdm_filter()`](https://dm.cynkra.com/reference/deprecated.md) and
  [`filter.dm_zoomed()`](https://dm.cynkra.com/reference/dplyr_table_manipulation.md)
  ...
  [`cdm_apply_filters()`](https://dm.cynkra.com/reference/deprecated.md).
...
- Joins on zoomed dm objects now supported
  ...
  [`cdm_flatten_to_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
...
- Add name repair argument for both
  [`cdm_insert_zoomed_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
  and [`cdm_add_tbl()`](https://dm.cynkra.com/reference/deprecated.md),
...
- Redesign constructors and validators:
  [`dm()`](https://dm.cynkra.com/reference/dm.md) is akin to
  [`tibble()`](https://tibble.tidyverse.org/reference/tibble.html),
  [`dm_from_src()`](https://dm.cynkra.com/reference/dm_from_src.md)
  works like [`dm()`](https://dm.cynkra.com/reference/dm.md) did
  previously, [`new_dm()`](https://dm.cynkra.com/reference/dm.md) only
  accepts a list of tables and no longer validates,
  [`validate_dm()`](https://dm.cynkra.com/reference/deprecated.md)
...
- [`cdm_select_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
...
- Many {dplyr} verbs now work on tables in a `dm`. Zooming to a table
  vie
  [`cdm_zoom_to_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
  creates a zoomed `dm` on which the {dplyr} verbs can be applied. The
  resulting table can be put back into the `dm` with
  [`cdm_update_zoomed_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
...
- New [`cdm_add_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
  and [`cdm_rm_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
  ([\#90](https://github.com/cynkra/dm/issues/90)).
- New [`cdm_get_con()`](https://dm.cynkra.com/reference/deprecated.md)
...
- [`cdm_enum_pk_candidates()`](https://dm.cynkra.com/reference/deprecated.md)
  and
  [`cdm_enum_fk_candidates()`](https://dm.cynkra.com/reference/deprecated.md)
...
- New
  [`cdm_squash_to_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
...
- New
  [`cdm_check_constraints()`](https://dm.cynkra.com/reference/deprecated.md)
  to check referential integrity of a `dm`
  ([\#56](https://github.com/cynkra/dm/issues/56)).
- [`cdm_copy_to()`](https://dm.cynkra.com/reference/deprecated.md) gains
  `table_names` argument
...
- Improve error message when calling
  [`cdm_add_pk()`](https://dm.cynkra.com/reference/deprecated.md) with a
  missing column.
...
- Improve error messages for
  [`cdm_join_to_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
  and
  [`cdm_flatten_to_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
...
- [`cdm_get_src()`](https://dm.cynkra.com/reference/deprecated.md) for
  local dm always returns a src based on `.GlobalEnv`.
...
- Add a vignette for joining functions
  ...
  [@cutterkom](https://github.com/cutterkom)).
- Shorten message in
  [`cdm_disambiguate_cols()`](https://dm.cynkra.com/reference/deprecated.md).
...
- Fix formatting in
  [`enum_pk_candidates()`](https://dm.cynkra.com/reference/dm_enum_pk_candidates.md)
  for character data.
- [`cdm_add_pk()`](https://dm.cynkra.com/reference/deprecated.md) and
  [`cdm_add_fk()`](https://dm.cynkra.com/reference/deprecated.md) no
...
- [`cdm_copy_to()`](https://dm.cynkra.com/reference/deprecated.md) works
  correctly with filtered `dm` objects.
- [`cdm_apply_filters()`](https://dm.cynkra.com/reference/deprecated.md)
...
- A more detailed README file and a vignette for filtering
  ...
  [@cutterkom](https://github.com/cutterkom)).
- [`cdm_draw()`](https://dm.cynkra.com/reference/deprecated.md) no
...
- [`cdm_nrow()`](https://dm.cynkra.com/reference/deprecated.md) returns
  named list ([\#49](https://github.com/cynkra/dm/issues/49)).
- Remove `cdm_semi_join()`.
- Remove `cdm_find_conn_tbls()` and the `all_connected` argument to
  [`cdm_select()`](https://dm.cynkra.com/reference/deprecated.md)
  ([\#35](https://github.com/cynkra/dm/issues/35)).
- Unexport `cdm_set_key_constraints()`.
- Rename [`cdm_select()`](https://dm.cynkra.com/reference/deprecated.md)
  to
  [`cdm_select_tbl()`](https://dm.cynkra.com/reference/deprecated.md),
  now uses {tidyselect}.
- [`cdm_nycflights13()`](https://dm.cynkra.com/reference/deprecated.md)
  now has `cycle = FALSE` as default.
- Rename `cdm_check_for_*()` to `cdm_enum_*()`.

### Performance

- [`cdm_filter()`](https://dm.cynkra.com/reference/deprecated.md) only
  records the filtering operation, the filter is applied only when
...
- New [`cdm_rename()`](https://dm.cynkra.com/reference/deprecated.md)
...
- [`as_dm()`](https://dm.cynkra.com/reference/dm.md) now also accepts a
  list of remote tables
  ([\#30](https://github.com/cynkra/dm/issues/30)).
- Use {tidyselect} syntax for
  [`cdm_rename_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
  and
  [`cdm_select_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
...
- [`cdm_filter()`](https://dm.cynkra.com/reference/deprecated.md) no
...
- [`new_dm()`](https://dm.cynkra.com/reference/dm.md)
- [`validate_dm()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_get_src()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_get_tables()`](https://dm.cynkra.com/reference/deprecated.md)
- `cdm_get_data_model()`
- [`is_dm()`](https://dm.cynkra.com/reference/dm.md)
- [`as_dm()`](https://dm.cynkra.com/reference/dm.md)

### Primary keys

- [`cdm_add_pk()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_has_pk()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_get_pk()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_get_all_pks()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_rm_pk()`](https://dm.cynkra.com/reference/deprecated.md)
- `cdm_check_for_pk_candidates()`

### Foreign keys

- [`cdm_add_fk()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_has_fk()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_get_fk()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_get_all_fks()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_rm_fk()`](https://dm.cynkra.com/reference/deprecated.md)
- `cdm_check_for_fk_candidates()`

### Visualization

- [`cdm_draw()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_set_colors()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_get_colors()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_get_available_colors()`](https://dm.cynkra.com/reference/deprecated.md)
...
- [`cdm_filter()`](https://dm.cynkra.com/reference/deprecated.md)
- `cdm_semi_join()`
- [`cdm_nrow()`](https://dm.cynkra.com/reference/deprecated.md)

### Interaction with DBs

- [`cdm_copy_to()`](https://dm.cynkra.com/reference/deprecated.md)
- `cdm_set_key_constraints()`
- [`cdm_learn_from_db()`](https://dm.cynkra.com/reference/deprecated.md)

### Utilizing foreign key relations

- [`cdm_is_referenced()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_get_referencing_tables()`](https://dm.cynkra.com/reference/deprecated.md)
- [`cdm_select()`](https://dm.cynkra.com/reference/deprecated.md)
- `cdm_find_conn_tbls()`
...
- [`check_key()`](https://dm.cynkra.com/reference/check_key.md)
- [`check_if_subset()`](https://dm.cynkra.com/reference/deprecated.md)
- [`check_set_equality()`](https://dm.cynkra.com/reference/check_set_equality.md)
- [`check_cardinality_0_n()`](https://dm.cynkra.com/reference/examine_cardinality.md)
- [`check_cardinality_1_n()`](https://dm.cynkra.com/reference/examine_cardinality.md)
- [`check_cardinality_1_1()`](https://dm.cynkra.com/reference/examine_cardinality.md)
