...
- `dm_get_all_pks()` now correctly shows the `autoincrement` column (works for MSSQL) (#1642)

## Bug fixes

- `copy_dm_to()` now works with fks that have `on_delete` argument set as `cascade` (#1677)
- `dm_get_all_fks()` now correctly shows the `on_delete` column (#1677)
