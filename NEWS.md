...
- Fixed key tracking for `summarise(.by = ...)` in zoomed, zoom2ed, and keyed
  dm (#2409, #2410).
...
- Fixed `dm_paste()` incorrectly splitting long pipelines by implementing
  operation chunking (#2301).
