...
- Trust the SQL Server certificate when creating the test database (#2498).

### ci

- Run SQL Server on Noble, and MySQL on 8.4 (#2497).

### ci

- Run MariaDB 12.3, the line that reaches Resolute (#2496).
...
- Auto-update from GitHub Actions (#2489).
...
- Auto-update from GitHub Actions (#2472).
