...
This package works with all data sources that provide a {dplyr} interface: local data frames, relational databases, and more.
...
The new class `dm` is contains all the important information about a set of related tables:

- a `src` object: location of tables (database, in-memory, ...)
- a `data_model` object: metadata about data model (keys, table & columns names, ...)
