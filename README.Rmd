...
dm is a [grammar of joined tables](https://twitter.com/drob/status/1224851726068527106), providing a consistent set of verbs for building, using and deploying relational data models. 
It bridges the gap in the data pipeline between individual dataframes and relational databases.

dm objects can be constructed from local dataframes or an RDBMS. 
dm objects support the full suite of dplyr data manipulation verbs along with additional methods for building data models, including key selection and creation as well as constraint checking. 
Once a data model is complete, dm provides methods for deployment to an RDBMS.   
...
Load data as a dm object (see [Getting started](https://krlmlr.github.io/dm/articles/dm.html) for details).
