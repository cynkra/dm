...
It's a [grammar of joined tables](https://twitter.com/drob/status/1224851726068527106) that provides a consistent set of verbs for building, using and deploying relational data models.
...
dm objects encapsulate relational data models built on top of lazy tables.
They can be constructed from local data frames or an RDBMS.
dm's lazy evaluation allows it to scale from datasets that fit in memory to databases with billions of rows.
