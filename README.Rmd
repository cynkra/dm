...
TL;DR: Are you using multiple data frames or database tables in R? Organize them with dm. Use it like a list of tables today. Build data models in it tomorrow. Deploy it to your organization's RDBMS the day after.   
