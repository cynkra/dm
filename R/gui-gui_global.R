            ...
            type <- shiny::div(
              ...
              dplyr::if_else(
                ...
                list(htmltools::span(
                  ...
                  title = "Primary key",
                  shiny::icon(verify_fa = FALSE, "key")
                )),
                list(NULL)
              ),
              dplyr::if_else(
                ...
                list(htmltools::span(
                  style = "margin-right: 10px;",
                  title = "Child in foreign key",
                  shiny::icon(verify_fa = FALSE, "angle-double-right")
                )),
                list(NULL)
              ),
              dplyr::if_else(
                ...
                list(htmltools::span(
                  style = "margin-right: 10px;",
                  title = "Parent key",
                  shiny::icon(verify_fa = FALSE, "angle-double-left")
                )),
                list(NULL)
              ),
              shiny::span(
                ...
                title = paste0("Data type: ", data$type[index]),
                data$type[index]
              )
            )
