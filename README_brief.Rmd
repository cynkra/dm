...
The downside of this approach is that it is harder to merge together information from different data sources and to identify which entities refer to the same object, a common task when modelling or plotting data. To be mapped uniquley, the entities would need to be designated as _keys_, and the separate tables collated together through a process called _joining_. 
