...
- [`left_join(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_join.md)
  ...
  [`cross_join(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_join.md)
  [`cross_join(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_join.md)
  :

  dplyr join methods for zoomed dm objects

- [`filter(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`filter(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`filter_out(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`filter_out(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`mutate(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`mutate(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`transmute(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`transmute(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`select(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`select(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`relocate(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`relocate(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`rename(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`rename(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`distinct(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`distinct(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`arrange(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`arrange(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`slice(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`slice(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  ...
  [`ungroup(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  ...
  [`reframe(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`reframe(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`count(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`count(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`tally(`*`<dm_zoomed>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
  [`tally(`*`<dm_keyed_tbl>`*`)`](https://dm.cynkra.com/dev/reference/dplyr_table_manipulation.md)
