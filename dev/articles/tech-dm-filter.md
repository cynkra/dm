...
[`dm::dm_nycflights13()`](https://dm.cynkra.com/dev/reference/dm_nycflights13.md)
...
[`as_dm()`](https://dm.cynkra.com/dev/reference/dm.md) functions. See
...
[`dm_filter()`](https://dm.cynkra.com/dev/reference/dm_filter.md) allows
you to select a subset of a `dm` object.
...
[`dm::dm_filter()`](https://dm.cynkra.com/dev/reference/dm_filter.md).
With this function one or more filtering conditions can be set for one
of the tables of the `dm` object. These conditions are immediately
...
[`dm_filter()`](https://dm.cynkra.com/dev/reference/dm_filter.md), we
copy the `flights`, `airlines` and `airports` tables from the
