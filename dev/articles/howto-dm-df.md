...
[`dm()`](https://dm.cynkra.com/dev/reference/dm.md), passing in the
...
The [`as_dm()`](https://dm.cynkra.com/dev/reference/dm.md) function is
an alternative that works if you already have a list of tables.
...
[`dm_add_pk()`](https://dm.cynkra.com/dev/reference/dm_add_pk.md) to add
them.
...
[`dm_add_fk()`](https://dm.cynkra.com/dev/reference/dm_add_fk.md) to add
...
[`dm_add_fk()`](https://dm.cynkra.com/dev/reference/dm_add_fk.md), the
...
call to
[`dm_add_fk()`](https://dm.cynkra.com/dev/reference/dm_add_fk.md) we
...
[`dm_draw()`](https://dm.cynkra.com/dev/reference/dm_draw.md) at any
stage of the process to generate a visual representation of the tables
