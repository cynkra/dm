...
test_that("check_api() new interface",{
  ...
  expect_same(
    check_api(data_mcard_1(),data_mcard_2(),x_select=a,y_select=b,by_position=T),
    check_api(x=data_mcard_1(),data_mcard_2(),x_select=a,y_select=b,by_position=T),
    check_api(data_mcard_1(),y=data_mcard_2(),x_select=a,y_select=b,by_position=T),
    check_api(
      x=data_mcard_1(),
      y=data_mcard_2(),
      x_select=a,
