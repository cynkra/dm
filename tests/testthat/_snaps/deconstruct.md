...
# joins with other child PK
    ...
    Message
      dm::dm(
        ...
        dm::dm_select(`<dm_kyd_t[,2]>`, a, c) %>%
        dm::dm_select(`<dm_kyd_t[,1]>`, b) %>%
        dm::dm_select(r, a, c) %>%
        dm::dm_add_pk(`<dm_kyd_t[,2]>`, c) %>%
        dm::dm_add_pk(`<dm_kyd_t[,1]>`, b) %>%
        dm::dm_add_pk(r, c) %>%
        dm::dm_add_fk(`<dm_kyd_t[,2]>`, a, `<dm_kyd_t[,1]>`) %>%
        dm::dm_add_fk(r, a, `<dm_kyd_t[,1]>`) %>%
        dm::dm_add_fk(`<dm_kyd_t[,2]>`, a, r, a)
    Code
    ...
    Message
      dm::dm(
        ...
        dm::dm_add_pk(r, c) %>%
        dm::dm_add_fk(`<dm_kyd_t[,2]>`, a, `<dm_kyd_t[,1]>`) %>%
        dm::dm_add_fk(r, b, `<dm_kyd_t[,1]>`) %>%
        dm::dm_add_fk(`<dm_kyd_t[,2]>`, a, r, b)
...
# joins with other child PK and name conflict
    ...
    Message
      dm::dm(
        ...
        dm::dm_select(`<dm_kyd_t[,2]>`, a, b) %>%
        dm::dm_select(`<dm_kyd_t[,1]>`, b) %>%
        dm::dm_select(r, a, b) %>%
        dm::dm_add_pk(`<dm_kyd_t[,2]>`, b) %>%
        dm::dm_add_pk(`<dm_kyd_t[,1]>`, b) %>%
        dm::dm_add_pk(r, b) %>%
        dm::dm_add_fk(`<dm_kyd_t[,2]>`, a, `<dm_kyd_t[,1]>`) %>%
        dm::dm_add_fk(r, a, `<dm_kyd_t[,1]>`) %>%
