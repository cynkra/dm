# build_copy_queries snapshot test for pixarfilms
    ...
    Output
      ...
      SELECT
        TRY_CAST("number" AS VARCHAR(MAX)) AS "number",
        TRY_CAST("film" AS VARCHAR(MAX)) AS "film",
        TRY_CAST("release_date" AS DATE) AS "release_date",
        TRY_CAST("run_time" AS FLOAT) AS "run_time",
        TRY_CAST("film_rating" AS VARCHAR(MAX)) AS "film_rating"
      FROM (
        VALUES
      ...
      SELECT
        TRY_CAST("film" AS VARCHAR(MAX)) AS "film",
        TRY_CAST("award_type" AS VARCHAR(MAX)) AS "award_type",
        TRY_CAST("status" AS VARCHAR(MAX)) AS "status"
      FROM (
        VALUES
      ...
      SELECT
        ...
        TRY_CAST("box_office_us_canada" AS FLOAT) AS "box_office_us_canada",
        TRY_CAST("box_office_other" AS FLOAT) AS "box_office_other",
        TRY_CAST("box_office_worldwide" AS FLOAT) AS "box_office_worldwide"
      FROM (
        VALUES
      ...
      SELECT
        TRY_CAST("film" AS VARCHAR(MAX)) AS "film",
        TRY_CAST("genre" AS VARCHAR(MAX)) AS "genre"
      FROM (
        VALUES
          ('Toy Story', 'Animation'),
          ('Toy Story', 'Adventure'),
      ...
      SELECT
        TRY_CAST("film" AS VARCHAR(MAX)) AS "film",
        TRY_CAST("rotten_tomatoes" AS FLOAT) AS "rotten_tomatoes",
        TRY_CAST("metacritic" AS FLOAT) AS "metacritic",
        TRY_CAST("cinema_score" AS VARCHAR(MAX)) AS "cinema_score",
        TRY_CAST("critics_choice" AS FLOAT) AS "critics_choice"
      FROM (
        VALUES
...
# build_copy_queries avoids duplicate indexes
    ...
    Output
      ...
      SELECT TRY_CAST("key" AS FLOAT) AS "key"
      FROM (  VALUES (1.0)) AS drvd("key")
      <SQL> INSERT INTO "parent2" ("a__key")
      SELECT TRY_CAST("a__key" AS FLOAT) AS "a__key"
