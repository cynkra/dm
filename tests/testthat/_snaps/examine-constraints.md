...
# output as tibble
    ...
    Output
      # A tibble: 7 x 7
        table    kind  columns ref_table is_pk is_key problem                         
        <chr>    <chr> <keys>  <chr>     <lgl> <lgl>  <chr>                           
      1 flights  FK    dest    airports  NA    FALSE  "values of `flights$dest` not i~
      2 flights  FK    tailnum planes    NA    FALSE  "values of `flights$tailnum` no~
      3 airlines PK    carrier <NA>      TRUE  TRUE   ""                              
      4 airports PK    faa     <NA>      TRUE  TRUE   ""                              
      5 planes   PK    tailnum <NA>      TRUE  TRUE   ""                              
      6 flights  FK    carrier airlines  NA    TRUE   ""                              
      7 flights  FK    origin  airports  NA    TRUE   ""                              
