...
# dm_get_all_pks() with table arg fails nicely
    ...
    You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'ROW('9E', 'Endeavor Air Inc.'),
        ROW('AA', 'American Airlines Inc.'),
        ...' at line 11 [1064]
