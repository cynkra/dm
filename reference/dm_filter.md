...
Filtering a table of a [`dm`](https://dm.cynkra.com/reference/dm.md)
...
`dm_filter()`. Calling
[`dm_apply_filters()`](https://dm.cynkra.com/reference/deprecated.md) or
[`dm_apply_filters_to_tbl()`](https://dm.cynkra.com/reference/deprecated.md)
is no longer necessary.

Use [`dm_zoom_to()`](https://dm.cynkra.com/reference/dm_zoom_to.md) and
[`dplyr::filter()`](https://dplyr.tidyverse.org/reference/filter.html)
