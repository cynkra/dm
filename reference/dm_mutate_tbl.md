# Update tables in a [`dm`](https://dm.cynkra.com/reference/dm.md)

**\[experimental\]**

Updates one or more existing tables in a
[`dm`](https://dm.cynkra.com/reference/dm.md). For now, the column names
must be identical. This restriction may be levied optionally in the
future.
