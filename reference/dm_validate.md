...
[`new_dm()`](https://dm.cynkra.com/reference/dm.md), all `dm` objects
created or modified by functions in this package should be valid, and
this function should not be needed. Please file an issue if any dm
operation creates an invalid object.
