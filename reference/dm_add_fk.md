...
- on_delete:
  ...
  **\[experimental\]**
  ...
  [`copy_dm_to()`](https://dm.cynkra.com/reference/copy_dm_to.md) with
  `set_key_constraints = TRUE`, and by
  [`dm_sql()`](https://dm.cynkra.com/reference/dm_sql.md), and might be
  considered by
  [`dm_rows_delete()`](https://dm.cynkra.com/reference/rows-dm.md) in a
  future version.
...
2.  when the PK or UK is removed
    ([`dm_rm_pk()`](https://dm.cynkra.com/reference/dm_rm_pk.md)/[`dm_rm_uk()`](https://dm.cynkra.com/reference/dm_rm_uk.md))
