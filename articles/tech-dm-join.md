...
[`?dm`](https://dm.cynkra.com/reference/dm.md) and the function
...
[`dm_wrap_tbl()`](https://dm.cynkra.com/reference/dm_wrap_tbl.md) with
[`pull_tbl()`](https://dm.cynkra.com/reference/pull_tbl.md) instead:
