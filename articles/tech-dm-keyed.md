...
and [`pull_tbl()`](https://dm.cynkra.com/reference/pull_tbl.md)
...
[`new_dm()`](https://dm.cynkra.com/reference/dm.md) to recombine the
...
[`dm()`](https://dm.cynkra.com/reference/dm.md). The bang-bang-bang
...
[`dm_wrap_tbl()`](https://dm.cynkra.com/reference/dm_wrap_tbl.md). In
such cases, it can be beneficial to “disentangle” the `dm` by
