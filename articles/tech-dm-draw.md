...
3.  [`dm_get_colors()`](https://dm.cynkra.com/reference/dm_set_colors.md)
4.  [`dm_get_available_colors()`](https://dm.cynkra.com/reference/dm_set_colors.md)
...
[`dm_set_colors()`](https://dm.cynkra.com/reference/dm_set_colors.md) is
a `dm` object. The information about the color is stored together with
...
[`dm_draw()`](https://dm.cynkra.com/reference/dm_draw.md) for further
options. One important argument is `view_type`. Besides the default
`"keys_only"`, it accepts `"all"` to display all columns, and
