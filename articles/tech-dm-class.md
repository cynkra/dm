...
1.  [`dm()`](https://dm.cynkra.com/reference/dm.md)
2.  [`as_dm()`](https://dm.cynkra.com/reference/dm.md)
3.  [`new_dm()`](https://dm.cynkra.com/reference/dm.md)
4.  [`dm_from_con()`](https://dm.cynkra.com/reference/dm_from_con.md)
...
[`new_dm()`](https://dm.cynkra.com/reference/dm.md), and add tables to
that object:
...
``` fansi
#> ── Table source ───────────────────────────────────────────────────────────
#> src:  sqlite 3.51.2 [/tmp/RtmpNsQqHg/nycflights13.sqlite]
#> ── Metadata ───────────────────────────────────────────────────────────────
#> Tables: `airlines`, `airports`, `flights`, `planes`, `weather`
#> Columns: 53
#> Primary keys: 0
...
[`new_dm()`](https://dm.cynkra.com/reference/dm.md) on a list of `tbl`
objects:
...
[`dm_validate()`](https://dm.cynkra.com/reference/dm_validate.md) if
necessary.
...
[`dm_get_con()`](https://dm.cynkra.com/reference/dm_get_con.md).
...
#> # Database: sqlite 3.51.2 [/tmp/RtmpNsQqHg/nycflights13.sqlite]
...
1.  [`dm_add_pk()`](https://dm.cynkra.com/reference/dm_add_pk.md)
2.  [`dm_get_all_pks()`](https://dm.cynkra.com/reference/dm_get_all_pks.md)
3.  [`dm_rm_pk()`](https://dm.cynkra.com/reference/dm_rm_pk.md)
4.  [`dm_enum_pk_candidates()`](https://dm.cynkra.com/reference/dm_enum_pk_candidates.md)
...
[`dm_add_pk()`](https://dm.cynkra.com/reference/dm_add_pk.md) has a
...
``` fansi
#> Error in check_key(airports, tzone) : 
...
1.  [`dm_add_fk()`](https://dm.cynkra.com/reference/dm_add_fk.md)
2.  [`dm_get_all_fks()`](https://dm.cynkra.com/reference/dm_get_all_fks.md)
3.  [`dm_rm_fk()`](https://dm.cynkra.com/reference/dm_rm_fk.md)
4.  [`dm_enum_fk_candidates()`](https://dm.cynkra.com/reference/dm_enum_fk_candidates.md)

Now it gets (even more) interesting: we want to define relations between
different tables. With the
[`dm_add_fk()`](https://dm.cynkra.com/reference/dm_add_fk.md) function
you can define which column of which table points to another table’s
column.
...
[`dm_add_fk()`](https://dm.cynkra.com/reference/dm_add_fk.md) will find
the primary key column of the referenced table by itself and make the
indicated column of the child table point to it.
...
``` fansi
#> Error in dm_add_fk(., flights, origin, airports) : 
...
``` fansi
#> Error in dm_add_fk(., flights, dest, airports, check = TRUE) : 
...
with[`dm_get_all_fks()`](https://dm.cynkra.com/reference/dm_get_all_fks.md):
...
[`dm_rm_fk()`](https://dm.cynkra.com/reference/dm_rm_fk.md) (parameter
`columns = NULL` means that all relations will be removed, with a
message):
...
``` fansi
#> Error in dm_rm_fk(., table = flights, column = dest, ref_table = airports) : 
...
(cf. [`dm_enum_pk_candidates()`](https://dm.cynkra.com/reference/dm_enum_pk_candidates.md)
